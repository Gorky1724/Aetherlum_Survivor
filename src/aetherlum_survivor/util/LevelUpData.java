...
public class LevelUpData {
    ...
    public static final int LVL_PRJ_UNLOCK_INTERVAL = 5; //every 5 levels is granted the unlocking of a new projectile
    ...
    public static final String FIRE_RATE_PV_DESCR = "FIRE RATE: -" + (int)(1 - FIRE_RATE_PV) + "%";
